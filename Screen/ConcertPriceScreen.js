    ...
    <View style={styles.container}>
      <ImageBackground style={styles.backImage}>
        ...
        <ScrollView style={{ flex: 1, padding: 20 }}>
          ...
          <Text style={styles.textTitle}><Image source={require('../res/imgs/music_ic.png')} ></Image>  The Grimme Concert</Text>
          <Text style={styles.concertDes}>December 25, 2019</Text>
          <Text style={styles.concertDes}>Lynn Doe</Text>
          <Text style={styles.concertDes}>3939 Broken Bone Road, Tooele UT</Text>
